describe('doublydoublyLinkedList', function() {
  ...
  it('should designate a new head when addToHead', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
  ...
  it('should contain every value that was added', function() {
    ...
    expect(doublyLinkedList.contains(4)).to.equal(true);
    expect(doublyLinkedList.contains(5)).to.equal(true);
    expect(doublyLinkedList.contains(12)).to.equal(true);
    expect(doublyLinkedList.contains(15)).to.equal(true);
  });
